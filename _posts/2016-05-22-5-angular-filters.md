...
[The next part can be found here]({{site.baseurl}}/code-projects/angular-quiz-app/6-ng-click-directive/)
...
Our list of turtles is really taking shape now! In the [next part]({{site.baseurl}}/code-projects/angular-quiz-app/6-ng-click-directive/) we will add the final touches which will been allowed to start building the quiz controller.

So I&#8217;ll see you over there in [part 6]({{site.baseurl}}/code-projects/angular-quiz-app/6-ng-click-directive/).
