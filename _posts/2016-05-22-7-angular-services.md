...
[The next part can be found here]({{site.baseurl}}/code-projects/angular-quiz-app/8-dependency-injection/)
...
Of course, we will add this controller into another [JavaScript]({{site.baseurl}}/tutorials/javascript-tuts/){: target="_blank"}<!--_--> file in our controller directory. So we will need to reference that script in the HTML. So are application scripts at the bottom of our HTML looks like this now.
...
I will see you over there in [part 8.]({{site.baseurl}}/code-projects/angular-quiz-app/8-dependency-injection/)
