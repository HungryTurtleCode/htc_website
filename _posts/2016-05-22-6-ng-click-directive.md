...
[The next part can be found here]({{site.baseurl}}/projects/angular-quiz-app/7-angular-services/)
...
See you over there in [part 7]({{site.baseurl}}/projects/angular-quiz-app/7-angular-services/).
