...
[The next part can be found here]({{site.baseurl}}/code-projects/angular-quiz-app/18-marking-the-quiz/)
...
We called the markQuiz function but it is yet to be created. So in the [next part]({{site.baseurl}}/code-projects/angular-quiz-app/18-marking-the-quiz/) we will create that function inside the quizMetrics factory.

See you in [part 18.]({{site.baseurl}}/code-projects/angular-quiz-app/18-marking-the-quiz/)
