...
[Here is the next part]({{site.baseurl}}/code-projects/angular-quiz-app/12-controller-logic/)
...
So I will see you there, in [part 12]({{site.baseurl}}/code-projects/angular-quiz-app/12-controller-logic/).
