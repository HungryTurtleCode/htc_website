...
In [part 2 of this series]({{site.baseurl}}/projects/angular-quiz-app/2-ng-controller-scope/) we will take a look at how we can create a property on our controller and utilise that inside our HTML using this new syntax.
