...
[The next part can be found here]({{site.baseurl}}/code-projects/angular-quiz-app/16-bootstrap-alerts/)
...
Moving swiftly on to [part 16]({{site.baseurl}}/code-projects/angular-quiz-app/16-bootstrap-alerts/) of this tutorial series. In the next part we will take a look at adding some basic error handling and the final parts of the quiz controller.

See you in [part 16.]({{site.baseurl}}/code-projects/angular-quiz-app/16-bootstrap-alerts/)
